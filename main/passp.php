...
<head>
  ...
  <title>EWUSIDAN CONSULT - PASSPORT APPLICATION</title>
  <!-- favicons -->
...
<meta property="og:type" content="website">
  ...
  <link rel="stylesheet" href="https://bootstrapdash.com/demo/wizard-free-2/assets/css/bd-wizard.css">
</head>
<body>
  <main class="my-5">
    <div class="container">
      <div id="wizard">
        ...
        <h3>
          <div class="media">
            <div class="bd-wizard-step-icon"><i class="mdi mdi-bank"></i></div>
            <div class="media-body">
              <div class="bd-wizard-step-title">Dollar</div>
              <div class="bd-wizard-step-subtitle">Step 2</div>
            </div>
          </div>
        </h3>
        <section>
          <div class="content-wrapper">
            <h4 class="section-heading">DOlllad </h4>
            <div class="row">
              <div class="form-group col-md-6">
                <label for="designation" class="sr-only">Designation</label>
                <input type="text" name="designation" id="designation" class="form-control" placeholder="Designation">
...
<footer>
  ...
  <script src="https://bootstrapdash.com/demo/wizard-free-2/assets/js/jquery.steps.min.js"></script>
  <script src="https://bootstrapdash.com/demo/wizard-free-2/assets/js/bd-wizard.js"></script>
</body>
</html>